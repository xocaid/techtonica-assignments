...
//         <h2>The oaxWeat in {oaxWeat.name} is currently:</h2>

//         <img src={'http://openweathermap.org/img/wn/03n@2x.png'} alt="cloudy" />
//         <p><b>City:</b> {oaxWeat.name}</p>
//         {/* <p><b>Description: </b> {oaxWeat.weather.description}</p>  */}
//         <p><b>Temperature: </b> {oaxWeat.main.temp}</p>
//         <p><b>Max Temp: </b> {oaxWeat.main.temp_max}</p>
//         <p><b>Min Temp: </b> {oaxWeat.main.temp_min}</p>
//         <p><b>Humidity: </b> {oaxWeat.main.humidity}</p>
//         <p><b>Sunrise: </b> {oaxWeat.sys.sunrise}</p>
//         <p><b>Sunset: </b> {oaxWeat.sys.sunset}</p>
//       </div>
//     )
//   };
// };
